...
class MP3Player:
    ...
    def __init__(self, start_song = None, song_name = 'Sin canciones', is_top_level = False):
    ...
    def load_labels(self):
        ...
        self.song_lbl = Label(label_frame, text=self.song_name, font=("Bahnschrift Condesed", "9", "bold"), bg='#F4F6F7')
        self.song_lbl.pack()
        ...
        try:
            ...
            if self.first_time:
                ...
                if self.start_song is None:
                    ...
                    self.load_play(self.start_song)
            else:
